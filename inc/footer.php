...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p> 
                    Somos una empresa lider en Innovacion que </br>
                    ofrece productos de calidad a bajos precios.</br>
    ...
    <br><br><br>
    <h5 class="text-center tittles-pages-logo text-footer">Xtreme AI &copy; 2024</h5>
</footer>
